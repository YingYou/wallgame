...
import com.yw.FlowAuto.FlowDetailActivity;
...
//				time_stamp);
		...
		builder.setWhen(time_stamp);
		builder.setTicker("新消息");
		builder.setContentTitle("流量助手");
		builder.setContentText(context.getString(R.string.new_app_installed));
